...
EXPECTED_PATCH_ORDER = [
    ...
    "wine-11.12-forgeplay-xbox-iohid-normalization.patch",
    "wine-11.12-forgeplay-frame-generation-renderer-routing.patch",
    "wine-11.12-vulkan-renderer-wined3d-query-policy.patch",
    "wine-11.12-wow64-vulkan-host-memory-ownership.patch",
    "wine-11.12-xinput-capability-resolution.patch",
    "wine-11.12-dynamic-unwind-registration-cache.patch",
    "wine-11.12-builtin-wined3d-process-policy.patch",
    "wine-11.12-wined3d-opengl-frame-generation-hooks.patch",
    "wine-11.12-macos-opengl-profile-sharing.patch",
    "wine-11.12-builtin-wined3d-vulkan-policy.patch",
    "wine-11.12-wined3d-vulkan-reset-shader-metadata.patch",
    "wine-11.12-vkd3d-partial-varying-initialization.patch",
    "wine-11.12-wined3d-legacy-vertex-interface.patch",
    "wine-11.12-wined3d-srgb-read-luminance-views.patch",
    "wine-11.12-wined3d-srgb-read-capability.patch",
]
