...
for html in index.html why.html license.html privacy.html support.html compatibility.html updates.html; do
  ...
  require_snippet "$ROOT_DIR/$html" 'src="site.js?v=20260923-copy1"'
...
require_snippet "$ROOT_DIR/index.html" 'macOS 26 or later · Rosetta required'
...
require_snippet "$ROOT_DIR/compatibility.html" 'Tell us what works—and what doesn’t.'
require_snippet "$ROOT_DIR/compatibility.html" 'Playable in Game Mode'
require_snippet "$ROOT_DIR/compatibility.html" 'Diagnostic logs help us investigate.'
...
require_snippet "$ROOT_DIR/compatibility.html" 'src="site.js?v=20260923-copy1"'
...
require_snippet "$ROOT_DIR/updates.html" 'Read release notes, project announcements, and progress updates.'
