...
for html in index.html why.html license.html privacy.html support.html compatibility.html updates.html; do
  ...
  if [[ "$html" == "compatibility.html" ]]; then
    ...
    require_snippet "$ROOT_DIR/$html" 'src="site.js?v=20260802-18"'
...
require_snippet "$ROOT_DIR/index.html" 'src="compatibility.js?v=20260802-18"'
...
require_snippet "$ROOT_DIR/compatibility.html" 'src="site.js?v=20260802-18"'
require_snippet "$ROOT_DIR/compatibility.html" 'src="compatibility.js?v=20260802-18"'
...
require_snippet "$ROOT_DIR/compatibility.js" 'const versionSummaryRecords = playableRecords.length'
require_snippet "$ROOT_DIR/compatibility.js" 'versionSummaryRecords.forEach(({ report }) => {'
