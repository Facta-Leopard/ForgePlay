...
for html in index.html why.html license.html privacy.html support.html compatibility.html updates.html; do
  ...
  if [[ "$html" == "compatibility.html" ]]; then
    ...
    require_snippet "$ROOT_DIR/$html" 'src="site.js?v=20260802-19"'
...
require_snippet "$ROOT_DIR/compatibility.html" 'src="site.js?v=20260802-19"'
require_snippet "$ROOT_DIR/compatibility.html" 'src="compatibility.js?v=20260802-19"'
