...
for html in index.html why.html license.html privacy.html support.html compatibility.html updates.html; do
  ...
  require_snippet "$ROOT_DIR/$html" 'src="locale-bootstrap.js?v=20260728-4"'
  require_snippet "$ROOT_DIR/$html" 'href="site.css?v=20260728-4"'
  require_snippet "$ROOT_DIR/$html" 'src="site.js?v=20260728-4"'
...
require_snippet "$ROOT_DIR/index.html" 'src="compatibility.js?v=20260728-4"'
require_snippet "$ROOT_DIR/index.html" 'src="announcements.js?v=20260728-4"'
require_snippet "$ROOT_DIR/index.html" 'src="developer-apps.js?v=20260728-4"'
...
require_snippet "$ROOT_DIR/compatibility.html" 'Working or broken—report what you see.'
...
require_snippet "$ROOT_DIR/compatibility.html" 'src="compatibility.js?v=20260728-4"'
...
require_snippet "$ROOT_DIR/updates.html" 'src="announcements.js?v=20260728-4"'
